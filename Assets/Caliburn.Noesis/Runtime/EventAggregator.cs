...
namespace Caliburn.Noesis
{
    ...
    public class EventAggregator : IEventAggregator
    {
        ...
        /// <inheritdoc />
        public virtual void Subscribe(object subscriber, Func<Func<UniTask>, UniTask> marshal)
        {
            if (subscriber == null)
            {
        ...
        /// <inheritdoc />
        public virtual UniTask PublishAsync(object message, Func<Func<UniTask>, UniTask> marshal, CancellationToken cancellationToken = default)
        {
            if (message == null)
            {
        ...
        {
            private readonly Func<Func<UniTask>, UniTask> _marshal;
            private readonly WeakReference _reference;
            private readonly Dictionary<Type, MethodInfo> _supportedHandlers = new Dictionary<Type, MethodInfo>();

            public Handler(object handler, Func<Func<UniTask>, UniTask> marshal)
            {
                _marshal = marshal;
            ...
            public UniTask Handle(Type messageType, object message, CancellationToken cancellationToken)
            {
