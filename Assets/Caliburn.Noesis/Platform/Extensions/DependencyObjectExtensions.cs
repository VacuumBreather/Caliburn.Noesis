namespace Caliburn.Noesis.Extensions
{
    ...
    public static class DependencyObjectExtensions
    {
        ...
        /// <summary>
        /// Goes up the visual tree, looking for the first element which is not marked as framework generated.
        /// </summary>
        /// <param name="dependencyObject">The starting point.</param>
        ...
        {
            while ((dependencyObject != null) && Noesis.View.GetIsGenerated(dependencyObject))
            {
                dependencyObject = VisualTreeHelper.GetParent(dependencyObject);
            }
