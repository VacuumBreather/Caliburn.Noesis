namespace Caliburn.Noesis
{
    ...
    /// <summary>
    ///     Specifies settings for configuring type mappings performed by the <see cref="ViewLocator" />.
    /// </summary>
    public class TypeMappingConfiguration
    {
        ...
        /// <summary>
        ///     The default sub-namespace for ViewModels. Used for creating default sub-namespace mappings. Defaults to
        ///     "ViewModels".
        /// </summary>
        public string DefaultSubNamespaceForViewModels { get; set; } = "ViewModels";

        /// <summary>
        ///     The default sub-namespace for Views. Used for creating default sub-namespace mappings. Defaults to "Views".
        /// </summary>
        ...
        /// <summary>
        ///     Flag to indicate whether or not the name of the Type should be transformed when adding a type mapping. Defaults to
        ///     true.
        /// </summary>
