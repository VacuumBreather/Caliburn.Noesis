namespace Caliburn.Noesis.Transitions
{
    ...
    public class FadeInEffect : TransitionEffectBase<FadeInEffect>
    {
        ...
        public override Timeline Build<TSubject>(TSubject effectSubject)
        {
            ...
            if (timeline is null || (target is null && targetName is null))
            {
                return null;
            }
        ...
        //    var endFrame =
        //        new EasingDoubleKeyFrame(1, effectSubject.Offset + OffsetTime + Duration)
        //            {
        ...
        private Timeline CreateSlide(double from, double to, TimeSpan initialOffset)
        {
            ...
            var endFrame =
                new EasingDoubleKeyFrame(to, initialOffset + OffsetTime + Duration)
                    {
                        EasingFunction = new SineEase()
                    };
