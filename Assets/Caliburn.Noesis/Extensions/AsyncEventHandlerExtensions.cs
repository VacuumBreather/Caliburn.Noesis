namespace Caliburn.Noesis.Extensions
{
    ...
    /// <summary>
    ///     Provides extension methods for the <see cref="AsyncEventHandler{TEventArgs}" /> type.
    /// </summary>
    public static class AsyncEventHandlerExtensions
    {
        ...
        /// <summary>
        ///     Gets all the event handlers attached to this delegate instance.
        /// </summary>
        ...
        /// <summary>
        ///     Invokes all event handlers asynchronously.
        /// </summary>
        /// <param name="handler">The event handler delegate instance.</param>
        ...
        public static UniTask InvokeAllAsync<TEventArgs>(
            ...
            where TEventArgs : EventArgs
        {
            return UniTask.WhenAll(Enumerable.Select(handler.GetHandlers(), handleAsync => handleAsync(sender, e)));
        }
