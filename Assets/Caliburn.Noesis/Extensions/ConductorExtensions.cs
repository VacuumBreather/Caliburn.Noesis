namespace Caliburn.Noesis.Extensions
{
    ...
    /// <summary>
    ///     Provides extension methods for the <see cref="IConductor" /> type.
    /// </summary>
    public static class ConductorExtensions
    {
        ...
        public static UniTask ActivateItemAsync(
        ...
        /// <param name="cancellationToken">(Optional) The cancellation token to cancel operation.</param>
        /// <returns>A task that represents the asynchronous operation.</returns>
        public static UniTask CloseItemAsync(
            this IConductor conductor,
            object item,
            CancellationToken cancellationToken = default)
        {
        ...
        /// <returns>A task that represents the asynchronous operation.</returns>
        public static UniTask CloseItemAsync<T>(
